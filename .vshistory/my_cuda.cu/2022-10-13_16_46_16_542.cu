...
static float(*device1_float_out)[4] = NULL, (*device2_float_out)[4] = NULL, (*device3_float_out)[4] = NULL, (*device4_float_out) = NULL;
static float* Amp_real_out = NULL, * Phi_imag_out = NULL;
static cufftComplex* U0_device_out = NULL;
