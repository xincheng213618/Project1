...
void Mycuda::ALL_calculate(cv::Mat Phi, cv::Mat real_filter, cv::Mat imag_filter, cv::Mat* Ipc, int nH_extend, int nW_extend, int i)
{
	CUDA_ALL_calculate(Phi, real_filter, imag_filter, Ipc, nH_extend, nW_extend, i);
}
